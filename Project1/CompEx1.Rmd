...
\begin{equation}
\boldsymbol x^T \boldsymbol \Sigma^{-1} \boldsymbol (\mu_0 - \mu_1) = \log\left(\frac{\pi_1}{\pi_0}\right) + \frac{1}{2} \boldsymbol \mu_1^T \boldsymbol \Sigma^{-1} \boldsymbol \mu_1 - \frac{1}{2} \boldsymbol \mu_0^T \boldsymbol \Sigma^{-1} \boldsymbol \mu_0
\end{equation}
